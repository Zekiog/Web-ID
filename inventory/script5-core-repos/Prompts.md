# Prompts - Core Repo Signal Pack

## Metadata
- Repository: Zekiog/Prompts
- URL: https://github.com/Zekiog/Prompts
- Default branch: main
- Primary language: TypeScript
- Visibility: private
- Description: Ana Chat Arayüzü Minimal ve sade tasarlanmış tam ekran chat arayüzü Üst kısımda Zion WebGod logosu ve platform ismi Sağ üst köşede kullanıcı profili ve ayarlar menüsü Sol kenar çubuğunda önceki konuşmalar listesi ve yeni konuşma başlatma butonu Ana chat alanında mesajlaşma geçmişi, AI

## Structure Signals
- Top directories (9): .github, .vscode, app, artifacts, components, hooks, lib, public, tests
- Top files (26): .env.example, .eslintrc.json, .github, .gitignore, .vscode, LICENSE, README.md, app, artifacts, biome.jsonc, components, components.json, drizzle.config.ts, hooks, lib, middleware.ts, next-env.d.ts, next.config.ts, package.json, playwright.config.ts, pnpm-lock.yaml, postcss.config.mjs, public, tailwind.config.ts, tests, tsconfig.json
- Detected technology signals: Node.js package boundary, Next.js runtime/application, TypeScript static typing pipeline, GitHub Actions CI/CD automation, Workflow automation footprint
